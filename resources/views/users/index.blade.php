            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">View User/Partner</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
      ...
      <div class="page-wrapper">
        ...
        @foreach ($users as $user)
            ...
            <td>
                ...
                <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModal<?php echo $user['id'] ?>">View</button>
        ...
        <!-- ===========================Modal pop up code=================================== -->
                      ...
                      <div class="modal-dialog">
                          ...
                          <h4 class="modal-title">Details</h4>
                            ...
                            <h5>Mobile Number : <?php echo $user['mobile']; ?></h5>
